...
| [UglyFeed](https://github.com/fabriziosalmi/UglyFeed) | Retrieve, aggregate, filter, evaluate, rewrite and serve RSS feeds using Large Language Models for fun, research and learning purposes. | ![6 days](https://img.shields.io/badge/6%20days-brightgreen?style=flat-square) | 113 |
| [proxmox-lxc-autoscale](https://github.com/fabriziosalmi/proxmox-lxc-autoscale) | Automatically scale the LXC containers resources on Proxmox hosts, with or without AI. | ![yesterday](https://img.shields.io/badge/yesterday-brightgreen?style=flat-square) | 40 |
...
| [webtek](https://github.com/fabriziosalmi/webtek) | WebTeK: the worldwide streaming teknival ꩜ | ![6 days](https://img.shields.io/badge/6%20days-brightgreen?style=flat-square) | 7 |
...
| [lws](https://github.com/fabriziosalmi/lws) | linux (containers) web services | ![6 days](https://img.shields.io/badge/6%20days-brightgreen?style=flat-square) | 3 |
...
| [flared](https://github.com/fabriziosalmi/flared) | Cloudflare all-in-one security deployment using GitHub Actions | ![today](https://img.shields.io/badge/today-brightgreen?style=flat-square) | 1 |
