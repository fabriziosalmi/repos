...
|------------|-------------|-----------|----|
| [caddy-waf](https://github.com/fabriziosalmi/caddy-waf) | Caddy WAF (Regex Rules, IP and DNS filtering, Rate Limiting, GeoIP, Tor, Anomaly Detection) | ![4 days](https://img.shields.io/badge/4%20days-brightgreen?style=flat-square) | 441 |
| [patterns](https://github.com/fabriziosalmi/patterns) | Automated OWASP CRS and Bad Bot Detection for Nginx, Apache, Traefik and HaProxy | ![4 days](https://img.shields.io/badge/4%20days-brightgreen?style=flat-square) | 257 |
...
| [DevGPT](https://github.com/fabriziosalmi/DevGPT) | Code togheter, right now! GPT powered code assistant to build project in minutes | ![6 days](https://img.shields.io/badge/6%20days-brightgreen?style=flat-square) | 63 |
...
| [cf-box](https://github.com/fabriziosalmi/cf-box) | cf-box is a set of Python tools to play with API and multiple Cloudflare accounts. | ![5 days](https://img.shields.io/badge/5%20days-brightgreen?style=flat-square) | 20 |
...
| [csv-anonymizer](https://github.com/fabriziosalmi/csv-anonymizer) | CSV fuzzer/anonymizer | ![6 days](https://img.shields.io/badge/6%20days-brightgreen?style=flat-square) | 10 |
...
| [EthicalAI](https://github.com/fabriziosalmi/EthicalAI) | Automate LLM ethical self-assessments via GitHub Actions | ![6 days](https://img.shields.io/badge/6%20days-brightgreen?style=flat-square) | 6 |
...
| [audiogen](https://github.com/fabriziosalmi/audiogen) | AI-Powered Sound Generation & Classification. | ![6 days](https://img.shields.io/badge/6%20days-brightgreen?style=flat-square) | 1 |
...
| [blockchain-poc](https://github.com/fabriziosalmi/blockchain-poc) | Utilizing blockchain technology to retrieve, process, and display domain blacklists through Python and a web interface | ![6 days](https://img.shields.io/badge/6%20days-brightgreen?style=flat-square) | 1 |
| [cloudflare-backup-actions](https://github.com/fabriziosalmi/cloudflare-backup-actions) | Cloudflare zones and records backup via Github Actions | ![6 days](https://img.shields.io/badge/6%20days-brightgreen?style=flat-square) | 1 |
| [gradios](https://github.com/fabriziosalmi/gradios) | Enhanced GPT Response Generator (CoT, ToT, ensemble models and voting quorum) | ![6 days](https://img.shields.io/badge/6%20days-brightgreen?style=flat-square) | 1 |
