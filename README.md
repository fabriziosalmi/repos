...
| [UglyFeed](https://github.com/fabriziosalmi/UglyFeed) | Retrieve, aggregate, filter, evaluate, rewrite and serve RSS feeds using Large Language Models for fun, research and learning purposes. | ![today](https://img.shields.io/badge/today-brightgreen?style=flat-square) | 112 |
...
| [proxmox-lxc-autoscale](https://github.com/fabriziosalmi/proxmox-lxc-autoscale) | Automatically scale the LXC containers resources on Proxmox hosts, with or without AI. | ![3 days](https://img.shields.io/badge/3%20days-brightgreen?style=flat-square) | 31 |
...
| [webtek](https://github.com/fabriziosalmi/webtek) | WebTeK: the worldwide streaming teknival ꩜ | ![today](https://img.shields.io/badge/today-brightgreen?style=flat-square) | 7 |
...
| [lws](https://github.com/fabriziosalmi/lws) | linux (containers) web services | ![today](https://img.shields.io/badge/today-brightgreen?style=flat-square) | 2 |
