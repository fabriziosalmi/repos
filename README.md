...
| [UglyFeed](https://github.com/fabriziosalmi/UglyFeed) | Retrieve, aggregate, filter, evaluate, rewrite and serve RSS feeds using Large Language Models for fun, research and learning purposes. | ![4 days](https://img.shields.io/badge/4%20days-brightgreen?style=flat-square) | 113 |
| [proxmox-lxc-autoscale](https://github.com/fabriziosalmi/proxmox-lxc-autoscale) | Automatically scale the LXC containers resources on Proxmox hosts, with or without AI. | ![1 week](https://img.shields.io/badge/1%20week-brightgreen?style=flat-square) | 38 |
...
| [webtek](https://github.com/fabriziosalmi/webtek) | WebTeK: the worldwide streaming teknival ꩜ | ![4 days](https://img.shields.io/badge/4%20days-brightgreen?style=flat-square) | 7 |
