...
|------------|-------------|-----------|----|
| [caddy-waf](https://github.com/fabriziosalmi/caddy-waf) | Caddy WAF (regex rule-based filtering, IP and DNS filtering, rate limiting, GeoIP, Tor blocking) | ![today](https://img.shields.io/badge/today-brightgreen?style=flat-square) | 347 |
...
| [proxmox-vm-autoscale](https://github.com/fabriziosalmi/proxmox-vm-autoscale) | Automatically scale virtual machines resources on Proxmox hosts | ![3 days](https://img.shields.io/badge/3%20days-brightgreen?style=flat-square) | 176 |
...
| [caddy-adf](https://github.com/fabriziosalmi/caddy-adf) | Yet another caddy WAF exploration | ![4 days](https://img.shields.io/badge/4%20days-brightgreen?style=flat-square) | 1 |
